...
const CropPanel: React.FC<CropPanelProps> = ({ onApplyCrop, onSetAspect, isLoading, isCropping }) => {
  ...
  const aspects: { name: AspectRatio, value: number | undefined, tooltip: string }[] = [
    { name: 'free', value: undefined, tooltip: 'Crop freely without any fixed aspect ratio.' },
    { name: '1:1', value: 1 / 1, tooltip: 'Constrain the crop area to a perfect square.' },
    { name: '16:9', value: 16 / 9, tooltip: 'Constrain the crop area to a widescreen (16:9) aspect ratio.' },
  ];
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col items-center gap-4 animate-fade-in backdrop-blur-sm">
      ...
      <div className="flex items-center gap-2">
        ...
        {aspects.map(({ name, value, tooltip }) => (
          <button
            key={name}
      ...
      <button
        ...
        title="Finalizes the crop and trims the image to the selected area."
