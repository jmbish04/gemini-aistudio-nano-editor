...
const StartScreen: React.FC<StartScreenProps> = ({ onFileSelect }) => {
  ...
  return (
    <div 
      ...
      title="Drag and drop an image file here to start editing"
    >
      <div className="flex flex-col items-center gap-6 animate-fade-in">
        ...
        <div className="mt-6 flex flex-col items-center gap-4">
            <label htmlFor="image-upload-start" title="Click to open the file selector and choose an image from your device" className="relative inline-flex items-center justify-center px-10 py-5 text-xl font-bold text-white bg-blue-600 rounded-full cursor-pointer group hover:bg-blue-500 transition-colors">
